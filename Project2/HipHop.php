        ...
        <div class="row bottom-chunk">
            <div class="col-md-3">
                <div class="hovereffect">
                    ...
                    <div class="overlay">
                        <h2>Kanye West</h2>
                        <a class="info" href="http://www.kanyewest.com/" target="_blank">More Info</a>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="hovereffect">
                    ...
                    <div class="overlay">
                        <h2>Danny Brown</h2>
                        <a class="info" href="http://xdannyxbrownx.com/" target="_blank">More Info</a>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="hovereffect">
                    ...
                    <div class="overlay">
                        <h2>Outkast</h2>
                        <a class="info" href="http://www.outkast.com/" target="_blank">More Info</a>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="hovereffect">
                    ...
                    <div class="overlay">
                        <h2>Death Grips</h2>
                        <a class="info" href="https://soundcloud.com/deathgrips" target="_blank">More Info</a>
                    </div>
                </div>
