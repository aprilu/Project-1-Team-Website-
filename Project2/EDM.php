        ...
        <div class="row bottom-chunk">
            <div class="col-md-3">
                <div class="hovereffect">
                    ...
                    <div class="overlay">
                        <h2>Flume</h2>
                        <a class="info" href="https://soundcloud.com/flume" target="_blank">More Info</a>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="hovereffect">
                    ...
                    <div class="overlay">
                        <h2>Daft Punk </h2>
                        <a class="info" href="https://www.daftpunk.com/" target="_blank">More Info</a>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="hovereffect">
                    ...
                    <div class="overlay">
                        <h2>Skrillex</h2>
                        <a class="info" href="https://soundcloud.com/skrillex" target="_blank">More Info</a>
                    </div>
                </div>
            ...
            <div class="col-md-3">
                <div class="hovereffect">
                    ...
                    <div class="overlay">
                        ...
                        <a class="info" href="https://soundcloud.com/giorgiomoroder" target="_blank">More Info</a>
                    </div>
                </div>
